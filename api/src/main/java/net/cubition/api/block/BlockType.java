...
public interface BlockType {
     ...
     * where <code>time</code> is in seconds and
     * <code>digSpeed</code> is a float equal to lower than 10. (10 is insta-break)<br/>
     * <br />
     * Example with a dig speed of 0.73: 2 * 0.73 = 1.46; integer value = 1<br />
     * When it reaches 10 the block is broken, so approximately after 14 seconds.<br />
     * <br />
     * Special cases<br />
     * 0 = unbreakable<br />
