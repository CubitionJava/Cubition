...
public abstract class CreatureBase extends EntityBase {
    ...
    /**
     * Sets this Creatures health. This value cannot go above the maximum health for this Creature.
     *
     ...
     *
     * @param health     The new health value
     * @param overloaded If true, health can exceed this Creatures maximum health
     */
