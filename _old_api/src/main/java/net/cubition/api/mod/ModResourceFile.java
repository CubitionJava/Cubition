...
public class ModResourceFile {
	 ...
	 */
	public ModResourceFile(String name, String author, String version,
			Class<Mod> main, Dependency[] dependencies) {
		this.name = name;
		this.author = author;
	 ...
	 */
	public ModResourceFile(String name, String author, String version,
			String main, Dependency[] dependencies) {
		this.name = name;
		this.author = author;
		this.version = version;
		this.main = main;
	...
	/**
	 * NOT YET IMPLEMENTED!! Initiates a new ModRersouceFile from from the URL
	 * 
	...
	public static final class Dependency {
		...
		public Dependency(String name, String author, String version,
		...
		public URL getDownloadURL() throws MalformedURLException {
			return new URL((source.endsWith("/") ? source : source + "/")
	...
	public Class<Mod> getMainClass() throws ClassNotFoundException,
			ClassCastException {
