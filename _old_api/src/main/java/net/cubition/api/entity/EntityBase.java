...
public abstract class EntityBase {
	 ...
	 * @setter {@link net.cubition.api.entity.EntityBase.teleport(Location);
	 *         net.cubition.entity.EntityBase.teleport(EntityBase)}
	 */
	 ...
	 *
	 * @param entity
	 *            the entity to teleport this entity to
	 */
